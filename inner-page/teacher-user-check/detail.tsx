      ...
      >
        <Form title="用户信息">
          ...
          <Form.Item label="学科专业">
            <Input placeholder="请填写学科专业" />
          </Form.Item>
          <Form.Item label="联系地址">
            <Input placeholder="请填写您的住址" />
          </Form.Item>
          <Form.Item label="资格证书">
            <Input placeholder="请填写获得的证书" />
          </Form.Item>
          <Form.Item label="个人简介">
            <Input.TextArea placeholder="请填写个人简介" />
          </Form.Item>
          <Form.Item label="成果简介">
            <Input.TextArea placeholder="请填写获得的项目成果" />
          </Form.Item>
          <Form.Item label="作证材料">
            <Row align="middle">
              <Col span={22}>
                <Input placeholder="可把相关的作证材料（证书或成果）照片或扫描文件压缩为rar，zip文件后上传" />
              </Col>
              <Col span={1}>
                <Button
